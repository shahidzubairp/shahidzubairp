...
┌──(shahid㉿github)-[~]
└─$ whoami
ECE engineer exploring cybersecurity & hardware security

┌──(shahid㉿github)-[~]
└─$ current_focus
Embedded systems security
RF protocols & hardware attacks
Web & mobile VAPT fundamentals

┌──(shahid㉿github)-[~]
└─$ projects
nuclei-device (Flipper Zero inspired)
subdomain-enumeration
password-strength-checker

┌──(shahid㉿github)-[~]
└─$ tools
ESP32 | STM32 | NRF | Arduino
Logic basics | UART | SPI | I2C
Burp | Nmap | Linux | Bash

┌──(shahid㉿github)-[~]
└─$ note
Attacks don't stop at software.
